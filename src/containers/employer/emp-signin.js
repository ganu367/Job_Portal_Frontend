...
function EmpSignin() {
    ...
    const handleSignin = async (event) => {
        ...
        try {
            const response = await axios.post("/auth/sign-in/employer",
            data,
            {
    ...
    return (
        <>
        <Form>
            <Form.Title>EMPLOYER SIGN IN</Form.Title>
            <Form.Line />
            {error &&
            <Form.Error>
                Error: {error}
            ...
            <Form.Text>
                New to our site? <Form.Link to="/employer/signup">Sign up now.</Form.Link>
            </Form.Text>
            {/* <Form.Text>
