...
import { useAxiosPrivate, useAlert, useFileSizeCheck, useValidFileExtension, useLoading, useAuth } from "../../hooks";
...
export default function EmpCreateJob() {
    ...
    const [hiringFor, setHiringFor] = useState(JWT?.user?.companyName);
    ...
    const [jobLoc, setJobLoc] = useState("Any");
    const [jobTenure, setJobTenure] = useState("Any");
    ...
    // useEffect(() => {
    //     if (fileAttach.length !== 0) {
    //         isValidFileExtension(fileAttach[0].name)
    //     }
    // }, [fileAttach])
    ...
    return (
        ...
        <Card width="75%">
            ...
            {generalTab && 
                <>
                    ...
                    <Card.InputColumn>
                        ...
                        <Card.InputContainer>
                            <Card.Input type="number" id="openings" onWheel={(e) => e.target.blur()} placeholder=" " autoComplete="off" onKeyDown={blockInvalidNumber} value={openings} onChange={({target}) => openingsHandler(target.value)} />
                    ...
                    <Card.InputColumn>
                        <Card.InputContainer suffix={"years"}>
                            <Card.Input type="number" id="expMin" onWheel={(e) => e.target.blur()} placeholder=" " autoComplete="off" onKeyDown={blockInvalidNumber} value={expMin} onChange={({target}) => expMinHandler(target.value)} />
                            <Card.Label htmlFor="expMin" mandatory>Minimum Experience</Card.Label>
                        </Card.InputContainer>
                        <Card.InputContainer suffix={"years"}>
                            <Card.Input type="number" id="expMax" onWheel={(e) => e.target.blur()} placeholder=" " autoComplete="off" onKeyDown={blockInvalidNumber} value={expMax} onChange={({target}) => expMaxHandler(target.value)} />
                            <Card.Label htmlFor="expMax">Maximum Experience</Card.Label>
                        </Card.InputContainer>
                    </Card.InputColumn>
                    <Card.InputColumn>
                        <Card.InputContainer>
                            <Card.Input type="number" id="salaryMin" onWheel={(e) => e.target.blur()} placeholder=" " autoComplete="off" onKeyDown={blockInvalidNumber} value={salaryMin} onChange={({target}) => salMinHandler(target.value)} />
                            <Card.Label htmlFor="salaryMin" mandatory>Minimum Salary</Card.Label>
                        </Card.InputContainer>
                        <Card.InputContainer>
                            <Card.Input type="number" id="salaryMax" onWheel={(e) => e.target.blur()} placeholder=" " autoComplete="off" onKeyDown={blockInvalidNumber} value={salaryMax} onChange={({target}) => salMaxHandler(target.value)} />
                    ...
                    <Card.InputColumn>
                        <Card.InputContainer>
                            <Card.Input file={fileAttach?.name} type="file" accept=".pdf,.docx,.doc,.xlsx" id="fileAttach" placeholder="Max. file size 1MB" autoComplete="off" onChange={({ target }) => fileAttachHandler(target.files)} />
                    ...
                    <Card.InputColumn>
                        ...
                        {/* <Card.InputColumn notResponsive>
                            <Card.InputContainer notAlone refPointer={countryRef}>
                                ...
                                <Card.Label htmlFor="country">Code</Card.Label>
                            ...
                            <Card.InputContainer notAlone>
                                <Card.Input type="number" id="country" placeholder=" " autoComplete="off" value={country} onChange={({target}) => setCountry(target.value)} />
                                <Card.Label htmlFor="country">country</Card.Label>
                            </Card.InputContainer>
                        </Card.InputColumn> */}
                </>
            }
            ...
            <Card.ButtonGroup marginTop>
                ...
                <Button disabled={isInvalid} onClick={() => handleAddJob()}>Post job</Button>
            </Card.ButtonGroup>
        </Card>
        {(jobFunctionModal) ?
            <Modal>
